...
package com.library.hermeseventbus;
...
import com.library.concurrentutils.ObjectCanary2;
...
public class HermesEventBus {
    ...
    public void init(Context context) {
        ...
        if (mMainProcess) {
            ...
            Hermes.setHermesListener(new OnHermesListener());
    ...
    public class OnHermesListener extends HermesListener {
